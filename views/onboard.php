...
<html lang="en">
<head>
  <title>What you should grow</title>
  <!-- Required meta tags -->
  <meta charset="utf-8">
...
<body class="fixed-nav sticky-footer bg-dark">
  ...
  <div class="container">
    <div class="top-jumbo jumbotron">
      <h1>Suggestions</h1>
      <p>Based on the season and your current location, the gurus have come up with a list of plants that are perfect for you.</p>
    </div>
    <!-- Icon Cards-->
    ...
    <div id="lastRow" class="row">
      <div class="col-12">
        <a href="?controller=home&action=manage" class="btn btn-success float-right">Go to Dashboard</a>
      </div>
    </div>
  </div>
  <!-- Optional JavaScript -->
