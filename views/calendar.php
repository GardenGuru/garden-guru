...
<html lang="en">
  ...
  <body class="bg-dark">
    ...
    <main role="main" class="container">
      <div class="top-jumbo jumbotron secondary-color">
        <h3 class="text-center">Personalized Calendar</h3>
        <div id="logoContainer" class="col-12 text-center">
          <p>Coming soon to a garden near you!</p>
          <img id="logo" style="" src="/img/gardenGuruLogoMini.png">
        </div>
      </div>
    </main>
    <!-- Optional JavaScript -->
